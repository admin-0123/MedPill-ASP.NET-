<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="EDP_Clinic.WebForm3" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 content-left">
                        ...
                        <p class="mb-0">
                            Donec luctus rhoncus dignissim. Integer blandit mattis arcu, id viverra orci condimentum a.
                    ...
                    <div class="col-lg-4 content-photo mt-lg-0 mt-md-5 mt-4">
                        <h4>About Us</h4>
                        <a href="#url">
                            <img src="assets/images/healthcare.jpg" class="img-fluid" alt="content-photo"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="w3l-counter-6">
        ...
        <div class="conuter-66-info py-5">
            <div class="container py-lg-5">
                ...
                nulla, corrupti accusamus ad perspiciatis temporibus cupiditate maxime aperiam distinctio!
                </p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="offset-lg-1 col-lg-6 left-cont sec-grid-ab mt-lg-0 mt-5">
                        <h4>Private Care Service -<br>
                            Certified by the Joint Commission</h4>
                        <p>
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. minus nec essitatibus ex asperiores 
                        nulla eos minima nihil similique, veritatis deserunt elit. Quia, voluptas?
                        </p>
                        <p class="mt-3">
                        ...
                        reiciendis culpa saepe iure ducimus adipisci id delectus, reprehenderit quos.
                        </p>
                ...
                <div class="counter-grids-info row">
                    ...
                    <div class="col-lg-6 offset-lg-6">
                        ...
                        <p>
                            ...
                            Vivamus a ligula quam. Ut blandit eu leo non suscipit. Duis feugiat tortor sed.
                        </p>
            ...
            <div class="container">
                ...
                <div class="row team-row">
                    ...
                    <div class="col-lg-3 col-6 team-main-19">
                        <div class="column-19">
                            <a href="team-single.html">
                                <img class="img-fluid" src="assets/images/team2.jpg" alt=" "></a>
                        </div>
                        <div class="right-team-9">
                    ...
                    <div class="col-lg-3 col-6 team-main-19 mt-lg-0 mt-4">
                        <div class="column-19">
                            <a href="team-single.html">
                                <img class="img-fluid" src="assets/images/team3.jpg" alt=" "></a>
                        </div>
                        <div class="right-team-9">
