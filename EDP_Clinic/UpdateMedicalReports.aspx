<%@ Page Title="Update Medical Report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateMedicalReports.aspx.cs" Inherits="EDP_Clinic.Patient_Update_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section class="w3l-contact py-5">
        <div class="container">
            <h2 class="mb-5">Update Medical Report</h2>
            <div class="row mb-5">
                <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <asp:Button ID="btn_submit" runat="server" Text="Submit" class="btn btn-primary btn-lg" OnClick="btn_submit_Click" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="tb_date" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
