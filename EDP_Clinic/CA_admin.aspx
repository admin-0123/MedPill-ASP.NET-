<%@ Page Title="Create Appintment - Receiptionist" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CA_admin.aspx.cs" Inherits="EDP_Clinic.CA_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <div class="form-group mb-5">
            <asp:Label ID="lbl_searchUser" runat="server" Text="Search User by Phone Number:"></asp:Label>
            <div class="input-group mb-3" style="width: 250px;">
                <asp:TextBox ID="tb_searchUser" runat="server" CssClass="form-control" placeholder="Phone No. of user..."></asp:TextBox>
                <div class="input-group-append">
                    <asp:Button ID="btn_searchUser" runat="server" Text="Search" OnClick="btn_searchUser_Click" CssClass="btn btn-primary" />
                </div>
            </div>
            <asp:Label ID="lbl_searchUserResult" runat="server"></asp:Label>
        </div>
        <div class="mb-5">
            <div>
