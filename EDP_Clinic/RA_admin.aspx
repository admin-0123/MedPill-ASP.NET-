<%@ Page Title="Reschedule Appointments - Receptionist" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RA_admin.aspx.cs" Inherits="EDP_Clinic.RA_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <div class="mb-3">
            <h4>
                <asp:Label ID="lbl_current_ad" runat="server" Text="Current Appointment Details"></asp:Label>
            </h4>
            <p>
