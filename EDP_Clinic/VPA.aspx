<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VPA.aspx.cs" Inherits="EDP_Clinic.VPA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"> Johnny Lim </li>
          <li class="breadcrumb-item" aria-current="page"> <a href=""> Past Appointments </a>  </li>
        ...
        <div class="card-header">
            ...
            <div class="row">
                ...
                <div class="col-2 col-sm-6 mt-2"> <button class="btn_Rsch bg-primary text-white"> View appointment details </button> </div>
                    ...
                    <div class="card-header">
            <div class="row">
                <div class="col-8">                            <h4> Date Time: 19 Nov 2020 (THU) 10:30AM</h4> </div>
                                <div class="col-4"></div>
            </div>
            <div class="row">
                      <div class="col-8">      <h4> Type: Diagnosis </h4> </div>
                <div class="col-4"></div>
            </div>
