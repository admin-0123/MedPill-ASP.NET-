<%@ Page Title="400 Error" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="400.aspx.cs" Inherits="EDP_Clinic._400" %>
    ...
    <section class="w3l-contact py-5" id="400_Error">
        <div class="container py-lg-3">
            <div class="mt-5 text-center">
                <h1 class="title mb-4">400 Error</h1>
